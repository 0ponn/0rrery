...
import { layoutTopology, type TopoNode, type TopoEdge, type LaidOutNode } from '../topology'
...
export function TopoGraph({ nodes, edges }: { nodes: TopoNode[]; edges: TopoEdge[] }) {
  const laid = useMemo(() => layoutTopology(nodes, edges), [nodes, edges])
